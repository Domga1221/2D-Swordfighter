...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            if(anim.runtimeAnimatorController.animationClips[i].name == "Player_evade")
            {
    ...
    void Update()
    {
        ...
        */
        ...
        if (Input.GetKeyUp(KeyCode.U))
        {
            ...
            {
                if (!enemy.GetComponent<EnemyMovement>().invincible)
                {
        ...
        if (Input.GetKeyDown(KeyCode.I) && Time.time > nextEvade)
        {
